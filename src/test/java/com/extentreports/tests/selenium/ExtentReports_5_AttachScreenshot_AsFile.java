...
public class ExtentReports_5_AttachScreenshot_AsFile {

	private static final String SRC_TEST_RESOURCES_CONFIG_XML = ".\\src\\test\\resources\\config.xml";
	private static final String REPORTS_SPARK_ATTACH_LOGO_USING_XML_HTML = "reports/Spark_AttachScreenshot_AsFile.html";
	...
	public void extent_attachScreenshotTest() {
		...
		try {
			test1.pass("Value Entered: ",
					MediaEntityBuilder.createScreenCaptureFromPath(Utilities.getScreenshotPath_AsFile(driver)).build());
		} catch (IOException e) {
