...
public class ExtentReports_5_Customised_And_List {

	private static final String REPORTS_SPARK_CUSTOMISED_HTML = "reports/Spark_Customised_List.html";
	...
	public void extentTest() throws IOException {
		...
		// Arrays.asList("Selenium", "Appium", "Rest-Assured").forEach(e ->
		// test1.pass(e));
		Arrays.asList("Selenium", "Appium", "Rest-Assured").forEach(e -> test1.pass(e));
		test1.pass(MarkupHelper.createOrderedList(Arrays.asList("Selenium", "Appium", "Rest-Assured")).getMarkup());
		test1.pass(MarkupHelper.createUnorderedList(Arrays.asList("Selenium", "Appium", "Rest-Assured")).getMarkup());
